...
output.folder <- "ssp_modeling/ssp_run/sisepuede_summary_results_run_sisepuede_run_2025-07-21T13;50;17.070059/"
dir.data <- paste0(output.folder)
file.name <-"WIDE_INPUTS_OUTPUTS.csv"

#load peru data  
data <- read.csv(paste0(dir.data,file.name)) 
data <- subset(data,region=="peru")
...
write.csv(test2,"ssp_modeling/Tableau/data/drivers_peru_250821.csv", row.names=FALSE)
